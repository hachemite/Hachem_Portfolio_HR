...
export const ui = {
  en: {
    ...
    'home.contact.text':
      'Want to discuss systems, AI, or a potential internship?',
  ...
  fr: {
    ...
    'home.contact.text':
      "Envie de discuter systèmes, IA, ou d'une opportunité de stage ?",
